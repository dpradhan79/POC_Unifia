...
public class ExamQueue {
	...
	private String ResFileName="DailyDashboard_ExamQueue_TestSummary";
	private String ResFileNameXML="DailyDashboard_ExamQueue_Result";
	...
	@Test(dataProvider="BrowserandURL",dataProviderClass=Unifia_Admin_Selenium.class)
	 public void examQueueVerificaitons(String browserP, String URL,String AdminDB) throws InterruptedException, IOException, AWTException, SQLException{
		...
		//Patientcount
		if (qvd_v.compareRes(DBP.expPatientCount,patientsCount,true)){
			result_PatCount="Passed: Expected= "+DBP.expPatientCount+";Actual= "+patientsCount;
		}else{
			result_PatCount="#Failed!#: Expected= "+DBP.expPatientCount+";Actual= "+patientsCount;
		}
		Description="Verifying Patient count on Exam Queue tab";
		Expected =Description;
		TestRes=Description+result_PatCount+"\r\n";
		IHV.Exec_Log_Result(ResFileNameXML, Description, Expected, result_PatCount);
		//ExamCount
		if (qvd_v.compareRes(DBP.expExamCount,examsCount,true)){
			result_ExamCount="Passed: Expected= "+DBP.expExamCount+";Actual= "+examsCount;
		}else{
			result_ExamCount="#Failed!#: Expected= "+DBP.expExamCount+";Actual= "+examsCount;
		}
		Description="Verifying Exam count on Exam Queue tab";
		Expected =Description;
		TestRes=TestRes+Description+result_ExamCount+"\r\n";;
		IHV.Exec_Log_Result(ResFileNameXML, Description, Expected, result_ExamCount);
		//ExamType1
		if (qvd_v.compareRes(DBP.expExamType1,examType1,true)){
			result_ExamType1="Passed: Expected Exam Name= "+DBP.expExamType1+";Actual Patient Count = "+examType1;
		}else{
			result_ExamType1="#Failed!#: Expected Exam Name= "+DBP.expExamType1+";Actual Patient Count = "+examType1;
		}
		Description="Verifying Exam Type1 Name";
		Expected =Description;
		TestRes=TestRes+Description+result_ExamType1+"\r\n";;
		IHV.Exec_Log_Result(ResFileNameXML, Description, Expected, result_ExamType1);
		//ExamType1Count
		if (qvd_v.compareRes(DBP.expExamType1Count,examType1Count,true)){
			result_ExamType1Count="Passed: Expected= "+DBP.expExamType1Count+";Actual= "+examType1Count;
		}else{
			result_ExamType1Count="#Failed!#: Expected= "+DBP.expExamType1Count+";Actual= "+examType1Count;
		}
		Description="Verifying Exam Type count for "+DBP.expExamType1;
		Expected =Description;
		...
		//ExamType2
		if (qvd_v.compareRes(DBP.expExamType2,examType2,true)){
			result_ExamType2="Passed: Expected= "+DBP.expExamType2+";Actual= "+examType2;
		}else{
			result_ExamType2="#Failed!#: Expected= "+DBP.expExamType2+";Actual= "+examType2;
		}
		Description="Verifying Exam Type2 Name";
		Expected =Description;
		TestRes=TestRes+Description+result_ExamType2+"\r\n";;
		IHV.Exec_Log_Result(ResFileNameXML, Description, Expected, result_ExamType2);
		//ExamType2Count
		if (qvd_v.compareRes(DBP.expExamType2Count,examType2Count,true)){
			result_ExamType2Count="Passed: Expected= "+DBP.expExamType2Count+";Actual= "+examType2Count;
		}else{
			result_ExamType2Count="#Failed!#: Expected= "+DBP.expExamType2Count+";Actual= "+examType2Count;
		}
		Description=Description="Verifying Exam Type count for "+DBP.expExamType2;
		Expected =Description;
