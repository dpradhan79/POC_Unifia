...
public class StoredScans_ReprocessingArea_NewCycleMgmt {
	...
	private String actualResult="\t\t\t StoredScans_ReprocessingArea_NewCycleMgmt_TestSummary \r\n\r\n"; 
	private String ForFileName;
	private String TestResFileName="StoredScans_ReprocessingArea_NewCycleMgmt_TestSummary_";
	...
	private String File="ReprocessingArea_NewCycleMgmt.xml";
	...
	public void Reprocessing_StoredScans(String browserP, String URL, String AdminDB) throws Exception {
		...
		FileName="StoredScans_ReprocessingArea_NewCycleMgmt_";
		...
		if(!IT_A.log.contains("#Failed!#")){
			try{
				...
				//Checking whether ScopeCycle table for ScopeID_FK=1 and CycleID=1 contains the AssociationID_FK for Stored scan of scope1 into the reprocessor
				Description="Checking whether ScopeCycle table for ScopeID_FK=1 and CycleID=1 contains the AssociationID_FK for scope1 into the reprocessor";
				Expected="ScopeCycle table for ScopeID_FK=1 and CycleID=1 should contain the AssociationID_FK for scope1 into the reprocessor";
				if(ScopeAssocID.contains(StoredScope1InAssocID)){
					Result="Pass- Scope cycle of Scope1 for Cycle 1 contains the Stored AssociationID("+StoredScope1InAssocID+") of Scope1 into Reprocessor";
					System.out.println(Result);
				}else{
					Result="#Failed!# - Scope cycle of Scope1 for Cycle 1 does not contain the Stored AssociationID("+StoredScope1InAssocID+") of Scope1 into Reprocessor";
					System.out.println(Result);
				}
				actualResult=actualResult+"\r\n\r\n"+Result;
				TH.WriteToTextFile(TestResFileName+ForFileName,actualResult);
				...
				//Checking whether ScopeCycle table for ScopeID_FK=1 and CycleID=1 contains the AssociationID_FK for MRC Pass for the reprocessor
				Description="Checking whether ScopeCycle table for ScopeID_FK=1 and CycleID=1 contains the AssociationID_FK for MRC Pass for the reprocessor";
				Expected="ScopeCycle table for ScopeID_FK=1 and CycleID=1 should contain the AssociationID_FK for MRC Pass for the reprocessor";
				if(ScopeAssocID.contains(StoredMRCAssocID)){
					Result="Pass- Scope cycle of Scope1 for Cycle 1 contains the Stored AssociationID("+StoredMRCAssocID+") of MRC Test Result";
					System.out.println(Result);
				}else{
					Result="#Failed!# - Scope cycle of Scope1 for Cycle 1 does not contain the Stored AssociationID("+StoredMRCAssocID+") of MRC Test Result";
					System.out.println(Result);
				}
				actualResult=actualResult+"\r\n\r\n"+Result;
				TH.WriteToTextFile(TestResFileName+ForFileName,actualResult);
				...
				//Checking whether ScopeCycle table for ScopeID_FK=1 and CycleID=1 contains the AssociationID_FK for scope1 out of the reprocessor 
				Description="Checking whether ScopeCycle table for ScopeID_FK=1 and CycleID=1 contains the AssociationID_FK for scope1 out of the reprocessor";
				Expected="ScopeCycle table for ScopeID_FK=1 and CycleID=1 should contain the AssociationID_FK for scope1 out of the reprocessor";
				if(ScopeAssocID.contains(StoredScope1OutAssocID)){
					Result="Pass- Scope cycle of Scope1 for Cycle 1 contains the Stored AssociationID("+StoredScope1OutAssocID+") of Scope out of Reprocessor";
					System.out.println(Result);
				}else{
					Result="#Failed!# - Scope cycle of Scope1 for Cycle 1 does not contain the Stored AssociationID("+StoredScope1OutAssocID+") of Scope out of Reprocessor";
					System.out.println(Result);
				}
				actualResult=actualResult+"\r\n\r\n"+Result;
				TH.WriteToTextFile(TestResFileName+ForFileName,actualResult);
				...
				//Checking whether ScopeCycle table for ScopeID_FK=2 and CycleID=1 contains the AssociationID_FK for scope2 into the reprocessor
				Description="Checking whether ScopeCycle table for ScopeID_FK=2 and CycleID=1 contains the AssociationID_FK for scope2 into the reprocessor";
				Expected="ScopeCycle table for ScopeID_FK=2 and CycleID=1 should contain the AssociationID_FK for scope2 into the reprocessor";
				if(ScopeAssocID.contains(StoredScope2InAssocID)){
					Result="Pass- Scope cycle of Scope2 for Cycle 1 contains the Stored AssociationID("+StoredScope2InAssocID+") of Scope into Reprocessor";
					System.out.println(Result);
				}else{
					Result="#Failed!# - Scope cycle of Scope2 for Cycle 1 does not contain the Stored AssociationID("+StoredScope2InAssocID+") of Scope into Reprocessor";
					System.out.println(Result);
				}
				actualResult=actualResult+"\r\n\r\n"+Result;
				TH.WriteToTextFile(TestResFileName+ForFileName,actualResult);
				...
				//Checking whether ScopeCycle table for ScopeID_FK=2 and CycleID=1 contains the AssociationID_FK for MRC Pass for the reprocessor
				Description="Checking whether ScopeCycle table for ScopeID_FK=2 and CycleID=1 contains the AssociationID_FK for MRC Pass for the reprocessor";
				Expected="ScopeCycle table for ScopeID_FK=2 and CycleID=1 should contain the AssociationID_FK for MRC Pass for the reprocessor";
				if(ScopeAssocID.contains(StoredMRCAssocID)){
					Result="Pass- Scope cycle of Scope2 for Cycle 1 contains the Stored AssociationID("+StoredMRCAssocID+") of MRC Test Result";
					System.out.println(Result);
				}else{
					Result="#Failed!# - Scope cycle of Scope2 for Cycle 1 does not contain the Stored AssociationID("+StoredMRCAssocID+") of MRC Test Result";
					System.out.println(Result);
				}
				actualResult=actualResult+"\r\n\r\n"+Result;
				TH.WriteToTextFile(TestResFileName+ForFileName,actualResult);
				...
				//Checking whether ScopeCycle table for ScopeID_FK=2 and CycleID=1 contains the AssociationID_FK for scope2 out of the reprocessor
				Description="Checking whether ScopeCycle table for ScopeID_FK=2 and CycleID=1 contains the AssociationID_FK for scope2 out of the reprocessor";
				Expected="ScopeCycle table for ScopeID_FK=2 and CycleID=1 should contain the AssociationID_FK for scope2 out of the reprocessor";
				if(ScopeAssocID.contains(StoredScope2OutAssocID)){
					Result="Pass- Scope cycle of Scope2 for Cycle 1 contains the Stored AssociationID("+StoredScope2OutAssocID+") of Scope out of Reprocessor";
					System.out.println(Result);
				}else{
					Result="#Failed!# - Scope cycle of Scope2 for Cycle 1 does not contain the Stored AssociationID("+StoredScope2OutAssocID+") of Scope out of Reprocessor";
					System.out.println(Result);
				}
				actualResult=actualResult+"\r\n\r\n"+Result;
				TH.WriteToTextFile(TestResFileName+ForFileName,actualResult);
