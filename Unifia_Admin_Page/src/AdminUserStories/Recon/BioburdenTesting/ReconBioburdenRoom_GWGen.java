...
public class ReconBioburdenRoom_GWGen {
	public AdminUserStories.Recon.BioburdenTesting.ReconBioburdenRoom_GWAPI AB;
	...
	private String ReconScanDataXMLFile="ReconScanData_BioBurden_ITConsole";
    ...
    Model model = new Model();
	 String FileA = "/yED_graphs/Reconciliation/Bioburden.graphml";
	 PathGenerator pathGenerator = new RandomPath(new EdgeCoverage(100));
	  ...
	  Result result =  new TestBuilder()
		 .addModel(FileA, new ReconBioburdenRoom_GWAPI().setPathGenerator(new RandomPath((StopCondition) new EdgeCoverage(100))))
		 .execute();
	 ...
	 try{
		  // Create file 
		  FileWriter fstream = new FileWriter("ReconBioburden_Edge_Summary.txt");
