...
public class MRC_GWGen {
	...
	public void edge(String browserP, String URL,String AdminDB) throws Exception {
		...
		String FileA = "/yED_graphs/Reconciliation/MRC.graphml";
		...
		Result result =  new TestBuilder()
		 .addModel(FileA, new MRC_GWAPI().setPathGenerator(new RandomPath((StopCondition) new EdgeCoverage(100))))
		 .execute();
	 ...
	 try{
		  	// Create file 
		  	FileWriter fstream = new FileWriter("Recon_MRC_Edge_Summary.txt");
		...
		if (MR.actualResult.contains("#Failed!#")||Unifia_Admin_Selenium.resultFlag.contains("#Failed!#")){
