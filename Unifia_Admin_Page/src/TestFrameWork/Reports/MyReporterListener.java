...
public class MyReporterListener implements IReporter   {
    ...
    public void generateReport(List<XmlSuite> xml, List<ISuite> suites, String outdir) {
        try {
        	...
        	filePath = new File(outdir+"/..");
            System.out.println(filePath.getCanonicalPath());
            m_out = createWriter(filePath.getCanonicalPath());
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
        ...
        return new PrintWriter(new BufferedWriter(new FileWriter(new File(
                outdir, "Unifia Regression Suite Summary Report"
                        + dateToDayAndTime(now)
                        + ".html"))));
    }
    ...
    public void generateSuiteSummaryReport(List<ISuite> suites) {
        ...
        for (ISuite suite : suites) {
            ...
            for (ISuiteResult r : tests.values()) {
                ...
                // NEW
                summaryCell(
                        dateToDayAndTime(overview.getStartDate()),
                        true);
                m_out.println("</td>");
                summaryCell(
                		dateToDayAndTime(overview.getEndDate()),
                        true);
                m_out.println("</td>");
    ...
    protected void startHtml(PrintWriter out) {
        ...
        out.println("<head>");
        out.println("<title>Unifia Regression Suite Summary Report</title>");
    ...
    public String dateToDayAndTime(Date DateforFileName){
    	DateFormat dateFormat = new SimpleDateFormat("yyyyMMddHHmmss");
		//Date date = new Date();
		String ForFileName = dateFormat.format(DateforFileName);
		return ForFileName;
    }
