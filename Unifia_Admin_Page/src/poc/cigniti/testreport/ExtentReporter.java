...
public class ExtentReporter implements IReporter {
	...
	@Override
	public void logSuccess(String stepName, String stepDescription, String screenShotPath, WebDriver driver) {
		
		try {	
			this.takeScreenShot(screenShotPath, driver);
	...
	@Override
	public void logFailure(String stepName, String stepDescription, String screenShotPath, WebDriver driver) {
	...
	@Override
	public void logInfo(String message, String screenShotPath, WebDriver driver) {
	...
	@Override
	public void logWarning(String stepName, String stepDescription, String screenShotPath, WebDriver driver) {
	...
	@Override
	public void logException(Throwable ex, String screenShotPath, WebDriver driver) {
	...
	@Override
	public void logFatal(Throwable ex, String screenShotPath, WebDriver driver) {
	...
	private synchronized void takeScreenShot(String screenShotPath, WebDriver webDriver) throws IOException, AWTException
	{
