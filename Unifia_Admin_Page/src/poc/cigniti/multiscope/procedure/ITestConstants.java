...
public interface ITestConstants {
	...
	String strSQLForWorkFlowValidation = "SELECT top 1 [ItemHistoryID_PK]\r\n" + 
			...
			"  Where l.Name='%s' and st.Name = '%s' and ls.LocationStateID_FK = '%s' and i.LastUpdatedDateTime,101) = convert(varchar(10),getdate(),101)\r\n" + 
			"  order by i.LastUpdatedDateTime DESC ";
	
	String strSQLForScopeAndStaffValidation = "SELECT top 1 [ItemHistoryID_PK]\r\n" + 
			"      ,[ScanItemID_FK]\r\n" + 
			"      ,[ScanItemTypeID_FK]\r\n" + 
			"      ,[DataSourceID]\r\n" + 
			"      ,[ReceivedDateTime]\r\n" + 		
